...
summary = summary(diamond_model)
```
<br />
As we can see the summary information: <br />
`r summary`
<br />
<br />
...
(pred = predict(log_pred_resp_model, newdata = new_carat, interval = c("prediction"), level = 0.99))
exp(log_pred_resp_model$coef[1] + log_pred_resp_model$coef[2] * 3)
```
