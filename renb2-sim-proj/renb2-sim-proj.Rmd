...
```{r}
hist(sim1_data$non_f, main = "Non-Significant F - Sigma = 1", prob = TRUE, breaks = 50)
x = sim1_data$non_f
curve(df(x, df1 = p - 1, df2 = n - p), col = "Orange", add = TRUE, lwd = 3)
```
```{r}
hist(sim2_data$non_f, main = "Non-Significant F - Sigma = 5", prob = TRUE, breaks = 50)
x = sim2_data$non_f
curve(df(x, df1 = p - 1, df2 = n - p), col = "Orange", add = TRUE, lwd = 3)
```
```{r}
hist(sim3_data$non_f, main = "Non-Significant F - Sigma = 10", prob = TRUE, breaks = 50)
x = sim3_data$non_f
curve(df(x, df1 = p - 1, df2 = n - p), col = "Orange", add = TRUE, lwd = 3)
```
```{r}
hist(sim1_data$non_p, main = 'Non-Significant P-Value - Sigma = 1', prob = TRUE, breaks = 40)
x = sim1_data$non_p
curve(dunif(x), col='orange', add=TRUE, lwd=3)
```
```{r}
hist(sim2_data$non_p, main = 'Non-Significant P-Value - Sigma = 5', prob = TRUE, breaks = 40)
x = sim2_data$non_p
curve(dunif(x), col='orange', add=TRUE, lwd=3)
```
```{r}
hist(sim3_data$non_p, main = 'Non-Significant P-Value - Sigma = 10', prob = TRUE, breaks = 40)
x = sim3_data$non_p
curve(dunif(x), col='orange', add=TRUE, lwd=3)
```

```{r}
hist(sim1_data$non_r, main = 'Non-Significant R Squared - Sigma = 1', prob = TRUE, breaks = 40)
x = sim1_data$non_r
curve(dbeta(x, (p-1)/2, (n-p)/2), col='orange', add=TRUE, lwd=3)
```
```{r}
hist(sim2_data$non_r, main = 'Non-Significant R Squared - Sigma = 5', prob = TRUE, breaks = 40)
x = sim2_data$non_r
curve(dbeta(x, (p-1)/2, (n-p)/2), col='orange', add=TRUE, lwd=3)
```
```{r}
hist(sim2_data$non_r, main = 'Non-Significant R Squared - Sigma = 10', prob = TRUE, breaks = 40)
x = sim2_data$non_r
curve(dbeta(x, (p-1)/2, (n-p)/2), col='orange', add=TRUE, lwd=3)
```
