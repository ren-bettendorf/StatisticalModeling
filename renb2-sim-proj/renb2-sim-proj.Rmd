...
colnames(power_full) = c("beta_1", "power_1", "power_2", "power_3")

ggplot(data=power_full, aes(x = beta_1)) + geom_line(aes(x = beta_1, y = power_1, color = "power_1"), size=1) +   geom_line(aes(x = beta_1, y = power_2, color = "power_2"), size=1) +
...
```{r}
power1 = power_data[which((power_data$n == 10) & (power_data$sigma == 2)), c("beta_1", "power")]
...
```{r}
power1 = power_data[which((power_data$n == 10) & (power_data$sigma == 4)), c("beta_1", "power")]
