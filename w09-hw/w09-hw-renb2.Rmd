...
```
<br />
Excluding one point we can see that the data is fairly evenly spread out and looking at the QQ plot, we can see that it follows the line mostly, except for a couple of points at the edges so it appears no assumptions have been violated.
